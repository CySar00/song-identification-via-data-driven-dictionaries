...
for classid=1:numClass
   ...
   if  col_ids > size(training_feats,2)
           data_ids = find(colnorms_squared_new(training_feats(:,col_ids(1:size(training_feats,2)-1))) > 1e-6);   % ensure no zero data elements are chosen
