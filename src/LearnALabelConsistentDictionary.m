...
%}
labels = createLabels(pathToDBDirectory, numberOfClasses, sum(numberOfFrames));
...
save('C:\Users\saravanos\Desktop\audioFingerprinting_NEW\Dictionaries\Time\256\DB4\D_512_1024_100_100_iterations.mat', 'D1');
save('C:\Users\saravanos\Desktop\audioFingerprinting_NEW\Dictionaries\Time\256\DB4\W_512_1024_100_100_iterations.mat', 'W1');
save('C:\Users\saravanos\Desktop\audioFingerprinting_NEW\Dictionaries\Time\256\DB4\T_512_1024_100_100_iterations.mat', 'T1');
save('C:\Users\saravanos\Desktop\audioFingerprinting_NEW\Dictionaries\Time\256\DB4\X_512_1024_100_100_iterations.mat', 'X1');

save('.\trainingdata\dictionarydata1.mat','D1','X1','W1','T1');

save('C:\Users\saravanos\Desktop\audioFingerprinting_NEW\Dictionaries\Time\512\DB4\D_256_512_100_100_iterations.mat', 'D1');
fprintf('done!');
