...
% load the dictionary 
D = cell2mat(struct2cell(load('C:\Users\saravanos\Desktop\audioFingerprinting_NEW\Dictionaries\Frequency\129\DB1\D_128_256.mat')));

% load the hash maps 
HashMaps_Songs = struct2cell(load('C:\Users\saravanos\Desktop\audioFingerprinting_NEW\HashMaps_DBs\DB1\Frequency\129\HashMaps_Frames.mat'));
...
AudioClip = ExtractTheAudioClip(selectedMP3, 30); 
